...
visual_odo_initial( ...
    ...
    'MAX_TRANS_V_THRESHOLD', 0.22, ...
    'MAX_YAW_ROT_V_THRESHOLD', 10, ...
    'MAX_HEIGHT_V_THRESHOLD', 0.3, ... 
    'ODO_SHIFT_MATCH_HORI', 36, ...
    'ODO_SHIFT_MATCH_VERT', 20, ...
    'FOV_HORI_DEGREE', 90, ...
    'FOV_VERT_DEGREE', 50, ...
    'KEY_POINT_SET', [1600, 1683], ...
    'ODO_STEP', 1);
...
yaw_height_hdc_initial( ...
    ...
    'YAW_HEIGHT_HDC_GLOBAL_INHIB', 0.0003, ...
    'YAW_HEIGHT_HDC_VT_INJECT_ENERGY', 0.01, ...
    'YAW_ROT_V_SCALE', 1, ...  
    'HEIGHT_V_SCALE', 1, ...   
...
gc_initial( ...
    ...
    'GC_INHIB_Y_VAR', 2, ...
    'GC_INHIB_Z_VAR', 2, ...
    'GC_GLOBAL_INHIB', 0.00025, ...  
    'GC_VT_INJECT_ENERGY', 0.01, ...   
...
main(SynPerDataFile, ...
    ...
    'GT_EXP_Y_SCALING', 20, ...
    'GT_EXP_Z_SCALING', 20, ...
    'ODO_MAP_X_SCALING', -0.3, ...
    'ODO_MAP_Y_SCALING', 0.32, ...
    'ODO_MAP_Z_SCALING', 10, ...
    'EXP_MAP_X_SCALING', -0.3, ...
    'EXP_MAP_Y_SCALING', 0.35, ...
    'EXP_MAP_Z_SCALING', 10);